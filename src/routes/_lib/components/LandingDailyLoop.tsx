...
import { AdaptiveGrid, Heading, HStack, ReadinessRing, SimpleCard, Text, VStack } from "~/components";
    ...
    <section>
      <VStack gap="lg">
        ...
        <AdaptiveGrid cols={{ base: 1, md: 3 }} gap="md" align="stretch">
          {/* 1. План дня */}
          <SimpleCard className="h-full border border-border">
            <VStack gap="sm">
                ...
                <VStack gap="xs">
                  ...
                  <VStack gap="3xs">
                    <div className="relative h-2 rounded-full bg-muted-foreground/25">
                      ...
                      />
                      <span
                        className="absolute top-1/2 size-4 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-primary bg-card"
