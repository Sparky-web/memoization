...
/**
 * Точечных перегенераций карточек вопроса в календарный день МСК — мягкий анти-абьюз
 * лимит для всех тарифов: перегенерация не списывает квоту генераций, но каждый вызов —
 * отдельный запуск ИИ, без потолка ей можно бесплатно пересобирать весь экзамен.
 */
...
// Лимиты Pro: потолки fair-use — защита от злоупотребления дорогими вызовами ИИ.
